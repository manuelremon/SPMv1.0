...
class TransferTDABCAlgorithm(BaseAlgorithm):
        ...
        try:
            ...
            if not is_valid:
                return AlgorithmOutput(
                    ...
                    selected_option="transfer_failed",
            ...
            # 2. Construir lista de almacenes disponibles
            warehouses = self._build_warehouse_network(input_data)
            
            # 3. Definir actividades de transferencia (TDABC)
            ...
            # 5. Calcular costo TDABC detallado
            ...
            logger.error(f"TransferTDABC error: {e}")
            return AlgorithmOutput(
                algorithm_type=AlgorithmType.TRANSFER_TDABC,
                item_id=input_data.item_id,
                success=False,
    ...
    def get_metadata(self) -> Dict:
        ...
        return {
            ...
            "description": "Time-Driven ABC para transferencias"
        }
