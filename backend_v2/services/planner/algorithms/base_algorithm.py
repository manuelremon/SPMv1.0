"""
Arquitectura base para algoritmos de optimización.

Patrón Strategy con:
- BaseAlgorithm: Interfaz común
- AlgorithmRegistry: Registro dinámico
- AlgorithmExecutor: Ejecutor con fallback
- AlgorithmInput/Output: DTOs estándar

Adaptado de src/planner/algorithms/base_algorithm.py
"""
...
class AlgorithmType(Enum):
    ...
    RELEASE_MARGINAL_COST = "release_marginal_cost"      # Liberación
...
class AlgorithmInput:
    ...
    # Database session (opcional - para queries reales)
    db_session: Optional[Any] = None  # sqlalchemy.orm.Session
